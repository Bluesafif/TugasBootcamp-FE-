...
<body>
    <div class="container">
        ...
        <div class="content">
            <form <%out.println("action=\"/editkaryawan?id="+request.getAttribute("id_karyawan")+"\"");%> method="POST" class="form" id="myForm">
                <div class="field">
                    <label for="nama_karyawan">Nama Karyawan</label>
                    <input class="form-input" type="text" name="nama_karyawan" <% out.println("value=\""+request.getAttribute("nama_karyawan")+"\""); %> id="nama_karyawan">
                </div>
                <div class="field">
                ...
                <div class="field">
                    ...
                    <input class="form-input" type="number" name="gaji_pokok" <% out.println("value=\""+request.getAttribute("gaji_pokok")+"\""); %> id="gaji_pokok">
                </div>
                <div class="field">
